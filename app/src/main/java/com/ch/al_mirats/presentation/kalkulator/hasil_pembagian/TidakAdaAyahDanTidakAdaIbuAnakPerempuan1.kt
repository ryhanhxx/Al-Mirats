                ...
                if (cucuLaki == 0 && cucuPerempuan == 0) {
                    ...
                    if (!adaIbunyaIbu) {
                        ...
                        if (jenisKelaminPewaris.equals("Laki-Laki")) {
                            ...
                            hartaIbunyaAyah = harta * 4 / 24
                            sisaHarta =
                                harta - hartaAnakPerempuan - hartaIstri - hartaIbunyaIbu - hartaIbunyaAyah
                            hartaCucuLaki =
                                sisaHarta * (cucuLaki + cucuLaki) / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()
                            hartaCucuPerempuan =
                                (sisaHarta * (cucuPerempuan / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()))
                ...
                if (cucuLaki == 0 && cucuPerempuan == 0) {
                    ...
                    if (!adaIbunyaIbu) {
                        ...
                        if (jenisKelaminPewaris.equals("Laki-Laki")) {
                            ...
                            hartaIbunyaAyah = harta * 2 / 13
                            sisaHarta =
                                harta - hartaAnakPerempuan - hartaSuami - hartaIbunyaIbu - hartaIbunyaAyah
                            hartaCucuLaki =
                                sisaHarta * (cucuLaki + cucuLaki) / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()
                            hartaCucuPerempuan =
                                (sisaHarta * (cucuPerempuan / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()))
                ...
                if (cucuLaki == 0 && cucuPerempuan == 0) {
                    ...
                    if (!adaIbunyaIbu) {
                        ...
                        if (jenisKelaminPewaris.equals("Laki-Laki")) {
                            ...
                            hartaIbunyaAyah = harta * 4 / 24
                            sisaHarta =
                                harta - hartaAnakPerempuan - hartaIstri - hartaCucuPerempuan - hartaIbunyaAyah
                            hartaSaudaraSeayahSeibu =
                                sisaHarta * (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu) / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()
                            hartaSaudariSeayahSeibu =
                                (sisaHarta * (adaSaudariSeayahSeibu / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()))
                ...
                if (cucuLaki == 0 && cucuPerempuan == 0) {
                    ...
                    if (!adaIbunyaIbu) {
                        ...
                        if (jenisKelaminPewaris.equals("Laki-Laki")) {
                            ...
                            hartaAyahnyaAyah = harta * 4 / 24
                            sisaHarta =
                                harta - hartaAnakPerempuan - hartaIstri - hartaIbunyaIbu - hartaAyahnyaAyah
                            hartaCucuLaki =
                                sisaHarta * (cucuLaki + cucuLaki) / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()
                            hartaCucuPerempuan =
                                (sisaHarta * (cucuPerempuan / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()))
                ...
                if (cucuLaki == 0 && cucuPerempuan == 0) {
                    ...
                    if (!adaIbunyaIbu) {
                        ...
                        if (jenisKelaminPewaris.equals("Laki-Laki")) {
                            ...
                            hartaIbunyaAyah = harta * 4 / 24
                            sisaHarta =
                                harta - hartaAnakPerempuan - hartaIstri - hartaAyahnyaAyah - hartaIbunyaAyah
                            hartaCucuLaki =
                                sisaHarta * (cucuLaki + cucuLaki) / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()
                            hartaCucuPerempuan =
                                (sisaHarta * (cucuPerempuan / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()))
