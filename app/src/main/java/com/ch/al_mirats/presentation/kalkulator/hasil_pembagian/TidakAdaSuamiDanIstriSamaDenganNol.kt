    ...
    if (!adaAyah && !adaIbu) {
        if (anakPerempuan == 0) {
                    ...
                    if (adaSaudaraSeayahSeibu == 0 && adaSaudariSeayahSeibu == 0) {
                        if (cucuLaki == 0 && cucuPerempuan == 0) {
                            ...
                            if (!adaIbunyaIbu) {
                                ...
                                hartaCucuLaki =
                                    harta * (cucuLaki + cucuLaki) / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()
                                hartaCucuPerempuan =
                                    (harta * (cucuPerempuan / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()))
                            } else {
                                bagianIbunyaIbu = "1/6 → 1/6"
                                hartaIbunyaIbu = harta * 1 / 6
                                bagianCucuLaki = "Ashobah"
                                ...
                                hartaCucuLaki =
                                    sisaHarta * (cucuLaki + cucuLaki) / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()
                                hartaCucuPerempuan =
                                    (sisaHarta * (cucuPerempuan / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()))
                            }
                        }
                        ...
                        if (cucuLaki == 0 && cucuPerempuan == 0) {
                            if (!adaIbunyaIbu) {
                                ...
                                hartaSaudaraSeayahSeibu =
                                    harta * (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu) / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()
                                hartaSaudariSeayahSeibu =
                                    (harta * (adaSaudariSeayahSeibu / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()))
                            } else {
                                bagianIbunyaIbu = "1/6 → 1/6"
                                hartaIbunyaIbu = harta * 1 / 6
                                bagianSaudaraSeayahSeibu = "Ashobah"
                                ...
                                sisaHarta = harta - hartaIbunyaIbu
                                hartaSaudaraSeayahSeibu =
                                    sisaHarta * (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu) / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()
                                hartaSaudariSeayahSeibu =
                                    (sisaHarta * (adaSaudariSeayahSeibu / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()))
                            }
                        } else if (cucuPerempuan == 1 && cucuLaki == 0) {
                            if (!adaIbunyaIbu) {
                                bagianCucuPerempuan = "1/2 → 1/2"
                        ...
                        if (cucuLaki == 0 && cucuPerempuan == 0) {
                            ...
                            if (cucuPerempuan == 1) {
                                if (!adaIbunyaIbu) {
                                    ...
                                    hartaCucuPerempuan = harta * 3 / 6
                                    sisaHarta =
                                        harta - hartaIbunyaAyah - hartaCucuPerempuan - hartaIbunyaIbu
                                    hartaSaudaraSeayahSeibu =
                                        sisaHarta * (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu) / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()
                                    hartaSaudariSeayahSeibu =
                                        (sisaHarta * (adaSaudariSeayahSeibu / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()))
                    ...
                    if (adaSaudariSeayahSeibu > 0 && adaSaudaraSeayahSeibu == 0) {
                        if (adaSaudariSeayahSeibu >= 1) {
                            if (cucuLaki == 0 && cucuPerempuan == 0) {
                                ...
                                if (!adaIbunyaIbu) {
                                    ...
                                    hartaAyahnyaAyah = harta * 1 / 6
                                    sisaHarta =
                                        harta - hartaAyahnyaAyah - hartaIbunyaAyah - hartaIbunyaIbu
                                    hartaCucuLaki =
                                        sisaHarta * (cucuLaki + cucuLaki) / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()
                                    hartaCucuPerempuan =
                                        (sisaHarta * (cucuPerempuan / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()))
                        ...
                        if (cucuLaki == 0 && cucuPerempuan == 0) {
                            ...
                            if (!adaIbunyaIbu) {
                                ...
                                hartaIbunyaIbu = harta * 1 / 6
                                sisaHarta =
                                    harta - hartaAyahnyaAyah - hartaIbunyaIbu - hartaIbunyaAyah
                                hartaCucuLaki =
                                    sisaHarta * (cucuLaki + cucuLaki) / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()
                                hartaCucuPerempuan =
                                    (sisaHarta * (cucuPerempuan / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()))
            ...
            if (anakLaki >= 1) {
                ...
                hartaAnakLaki =
                    harta * (anakLaki + anakLaki) / (anakLaki + anakLaki + anakPerempuan).toDouble()
                hartaAnakPerempuan =
                    (harta * (anakPerempuan / (anakLaki + anakLaki + anakPerempuan).toDouble()))
                if (!adaIbunyaAyah && !adaAyahnyaAyah) {
                    if (adaSaudaraSeayahSeibu == 0 && adaSaudariSeayahSeibu == 0) {
                        if (cucuLaki == 0 && cucuPerempuan == 0) {
                            if (adaIbunyaIbu) {
                                ...
                                sisaHarta = harta - hartaIbunyaIbu
                                hartaAnakLaki =
                                    sisaHarta * (anakLaki + anakLaki) / (anakLaki + anakLaki + anakPerempuan).toDouble()
                                hartaAnakPerempuan =
                                    (sisaHarta * (anakPerempuan / (anakLaki + anakLaki + anakPerempuan).toDouble()))
                            }
                        } else {
                            bagianCucuLaki = "Mahjub"
                            bagianCucuPerempuan = "Mahjub"
                    ...
                    if (adaSaudaraSeayahSeibu == 0 && adaSaudariSeayahSeibu == 0) {
                        ...
                        if (cucuLaki == 0 && cucuPerempuan == 0) {
                            ...
                            if (!adaIbunyaIbu) {
                                ...
                                bagianSaudariSeayahSeibu = "Ashobah"
                                sisaHarta =
                                    harta - hartaAnakPerempuan - hartaCucuPerempuan - hartaIbunyaIbu
                                hartaSaudaraSeayahSeibu =
                                    sisaHarta * (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu) / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()
                                hartaSaudariSeayahSeibu =
                                    (sisaHarta * (adaSaudariSeayahSeibu / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()))
                    ...
                    if (adaSaudaraSeayahSeibu == 0 && adaSaudariSeayahSeibu == 0) {
                        if (cucuLaki == 0 && cucuPerempuan == 0) {
                            ...
                            if (!adaIbunyaIbu) {
                                ...
                                hartaIbunyaAyah = harta * 1 / 6
                                sisaHarta =
                                    harta - hartaAnakPerempuan - hartaIbunyaIbu - hartaIbunyaAyah
                                hartaCucuLaki =
                                    sisaHarta * (cucuLaki + cucuLaki) / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()
                                hartaCucuPerempuan =
                                    (sisaHarta * (cucuPerempuan / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()))
                        ...
                        if (cucuLaki == 0 && cucuPerempuan == 0) {
                            ...
                            if (!adaIbunyaIbu) {
                                ...
                                bagianSaudariSeayahSeibu = "Ashobah"
                                sisaHarta =
                                    harta - hartaAnakPerempuan - hartaCucuPerempuan - hartaIbunyaAyah
                                hartaSaudaraSeayahSeibu =
                                    sisaHarta * (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu) / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()
                                hartaSaudariSeayahSeibu =
                                    (sisaHarta * (adaSaudariSeayahSeibu / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()))
                    ...
                    if (adaSaudaraSeayahSeibu == 0 && adaSaudariSeayahSeibu == 0) {
                        if (cucuLaki == 0 && cucuPerempuan == 0) {
                            ...
                            if (!adaIbunyaIbu) {
                                ...
                                hartaAyahnyaAyah = harta * 1 / 6
                                sisaHarta =
                                    harta - hartaAnakPerempuan - hartaIbunyaIbu - hartaAyahnyaAyah
                                hartaCucuLaki =
                                    sisaHarta * (cucuLaki + cucuLaki) / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()
                                hartaCucuPerempuan =
                                    (sisaHarta * (cucuPerempuan / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()))
                    ...
                    if (adaSaudaraSeayahSeibu == 0 && adaSaudariSeayahSeibu == 0) {
                        if (cucuLaki == 0 && cucuPerempuan == 0) {
                            ...
                            if (!adaIbunyaIbu) {
                                ...
                                hartaIbunyaAyah = harta * 1 / 6
                                sisaHarta =
                                    harta - hartaAnakPerempuan - hartaAyahnyaAyah - hartaIbunyaAyah
                                hartaCucuLaki =
                                    sisaHarta * (cucuLaki + cucuLaki) / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()
                                hartaCucuPerempuan =
                                    (sisaHarta * (cucuPerempuan / (cucuLaki + cucuLaki + cucuPerempuan).toDouble()))
                    ...
                    if (adaSaudaraSeayahSeibu == 0 && adaSaudariSeayahSeibu == 0) {
                        ...
                        if (cucuLaki == 0 && cucuPerempuan == 0) {
                            ...
                            if (!adaIbunyaIbu || adaIbunyaIbu) {
                                ...
                                bagianSaudariSeayahSeibu = "Ashobah"
                                sisaHarta =
                                    harta - hartaAnakPerempuan - hartaCucuPerempuan - hartaIbu
                                hartaSaudaraSeayahSeibu =
                                    sisaHarta * (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu) / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()
                                hartaSaudariSeayahSeibu =
                                    (sisaHarta * (adaSaudariSeayahSeibu / (adaSaudaraSeayahSeibu + adaSaudaraSeayahSeibu + adaSaudariSeayahSeibu).toDouble()))
